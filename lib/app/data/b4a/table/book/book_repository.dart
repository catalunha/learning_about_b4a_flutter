...
import 'package:learning_about_b4a_flutter/app/core/models/book_model.dart';
import 'package:learning_about_b4a_flutter/app/core/models/publisher_model.dart';
import 'package:learning_about_b4a_flutter/app/data/b4a/entity/author_entity.dart';
import 'package:learning_about_b4a_flutter/app/data/b4a/entity/book_entity.dart';
  ...
  addAll() async {
    ...
    authorModelList.addAll([
      ...
      BookModel(
        ...
        typeBoolean: false,
        typeNumber: 2,
        typeDateTime: DateTime(2022, 11, 26, 12).add(const Duration(hours: 1)),
        typeArray: ['b', '2'],
        typePointerPublisher: PublisherModel(objectId: 'kyCtliyFaK'),
      ),
      BookModel(
